    ...
    <>
      ...
      <Drawer.Navigator
        ...
        <Drawer.Screen
          ...
          options={{
            drawerIcon: () => (
              <Image source={dicIcon} style={{width: 25, height: 25}} />
            ),
            headerTitleStyle: {
        ...
        <Drawer.Screen
          ...
          options={{
            drawerIcon: () => (
              <Image source={contactIcon} style={{width: 25, height: 25}} />
            ),
            headerTitleStyle: {
              fontFamily: 'Roboto-Bold',
              fontWeight: 800,
        ...
        <Drawer.Screen
          ...
          options={{
            drawerIcon: () => (
              <Image source={aboutIcon} style={{width: 25, height: 25}} />
            ),
            headerTitleStyle: {
              fontFamily: 'Roboto-Bold',
              fontWeight: 800,
        ...
        <Drawer.Screen
          ...
          options={{
            drawerIcon: () => (
              <Image source={helpIcon} style={{width: 25, height: 25}} />
            ),
            headerTitleStyle: {
              fontFamily: 'Roboto-Bold',
              fontWeight: 800,
